...
def calc_percent(total_people, listT):
    percentage = (listT/total_people)*100
    return percentage
...
while day_count <= int(Time_duration):
                ...
                if hexMatrix[x][y] == 3:
                    ...
                    if x+1 < hexMatrix_size and y-1 > -1:
                        ...
                        if hexMatrix[x+1][y-1] == 1:
                            ...
                            Dead = 1
                #vaccinations            
                if rate_of_vaccination >  round(random.random(),2):  # CHRIS SET LIMIT 
                    hexMatrix[x][y] = 4
    ...
    l1.append(calc_percent(hexMatrix_size**2, num_susceptible))

    l2.append(calc_percent(num_susceptible, num_infected))

    l3.append(calc_percent(num_susceptible, num_recovered))

    l4.append(calc_percent(num_susceptible, num_dead))

    l5.append(calc_percent(num_susceptible, num_vaccinated))
...
#plt.xticks([e+1 for e in x1])    
    ...
    # print(l1)      #test if lists stored correctly 
    # print(l2)
...
#     duration = 100#int(input("input the duration of the simulation"))
    ...
    if day_count == Time_duration:
        ...
        def animate(i):
            ...
            axes.plot(x1,y2, color="green", linewidth=3)
